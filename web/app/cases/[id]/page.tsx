...
export default function CasePage({
  ...
  const deleteCase = async () => {
    if (
      !confirm(
        `Delete case #${id} and all associated files?\nThis cannot be undone.`,
      )
    )
      return;
  ...
  const q = data.raw_result?.quality ?? {
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div className="card">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <div className="meta-item">
                ...
                <ToothPills
                  teeth={p.prep_teeth_fdi ?? data.prep_teeth_fdi ?? []}
                />
              </div>
              {(p.bridge_region_fdi ?? data.bridge_region ?? []).length > 0 && (
                <div className="meta-item">
                  ...
                  <ToothPills
                    teeth={p.bridge_region_fdi ?? data.bridge_region}
                  />
                </div>
              )}
              <div className="meta-item">
          ...
          <div className="card">
            ...
            {(q.flags ?? []).length === 0 ? (
              <div style={{ color: "var(--pass)", fontSize: 13 }}>
                ✓ No issues detected
              </div>
            ) : (
